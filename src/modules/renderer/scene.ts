...
export class RendererScene {
    ...
    static setPositionAttribute(gl: WebGLRenderingContext, buffers: any, programInfo: any) {
    ...
    static setColorAttribute(gl: WebGLRenderingContext, buffers: any, programInfo: any) {
